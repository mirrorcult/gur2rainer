package net.flashpunk.debug
{
   ...
   public class Console
   {
      ...
      public function Console()
      {
         ...
         this._format = new TextFormat("console");
      ...
      public function enable() : void
      {
         ...
         this._fpsRead.graphics.drawRoundRectComplex(0,0,!!big?Number(200):Number(100),20,0,0,0,20);
         if(big)
         {
      ...
      private function updateLog() : void
      {
         ...
         else
         {
            ...
            this._logReadText1.text = !!this.LOG.length?this.LOG[this.LOG.length - 1]:"";
