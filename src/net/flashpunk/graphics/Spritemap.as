package net.flashpunk.graphics
{
   ...
   public class Spritemap extends Image
   {
      ...
      override public function update() : void
      {
         ...
         {
            this._timer = this._timer + (!!FP.fixed?this._anim._frameRate:this._anim._frameRate * FP.elapsed) * this.rate;
            if(this._timer >= 1)
            {
               while(this._timer >= 1)
               {
      ...
      {
         return !!this._anim?uint(this._index):uint(0);
      }
      ...
      {
         return !!this._anim?this._anim._name:"";
      }
