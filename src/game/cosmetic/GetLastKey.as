package game.cosmetic
{
   ...
   public class GetLastKey extends Pauser
   {
      ...
      private var key:LastKey;
      
      public function GetLastKey(key:LastKey)
      {
         ...
         Text.size = 48;
         this.text1 = new Text("THE ALMIGHTY");
